function Configure-AzureWinRMHTTPS {
  ...
  credit: http://www.techdiction.com/2016/02/12/powershell-function-to-enable-winrm-over-https-on-an-azure-resource-manager-vm/
  Problems - uses key id, should be value. replace https...should be http in this case? 
  got down to set-azure... -Blob
  -SkipCACheck - forget why that did not work
  #>
